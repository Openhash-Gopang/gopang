# -*- coding: utf-8 -*-
"""
make_realtime_module_v2.py
  src/gopang/p2p/webrtc-realtime.js 생성 (L1 SSE 우선 + Supabase WS 폴백)

L1 PocketBase Realtime: SSE 방식
  GET /api/realtime → text/event-stream
  구독: {"clientId":"...","subscriptions":["webrtc_signals/..."]}

Supabase Realtime: WebSocket (기존 방식, 폴백)
"""
import pathlib
...
dest = pathlib.Path("src/gopang/p2p/webrtc-realtime.js")
dest.parent.mkdir(parents=True, exist_ok=True)
dest.write_text(JS, encoding="utf-8")
print(f"생성/갱신 완료: {dest}")
