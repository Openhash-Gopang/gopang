...
- `src/gdc/currencyPool.js`(FIAT POOL 환율/지급준비금 20%), `src/gdc/tokenomics.js`,
  `src/gdc/escrow.js`, `src/gdc/dao.js`, `src/gdc/smartVault.js` — **전부 순수 로직일 가능성
  높음, Node.js 직접 실행 테스트 최우선 대상.**
