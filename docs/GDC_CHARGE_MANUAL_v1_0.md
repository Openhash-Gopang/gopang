...
> ## 🔶 베타 테스트 기간 한정 안내 (2026-08-17)
> 이 문서의 요금제는 **베타 테스트 기간 동안 잠정 보류**되고,
> [`BETA_UNIFIED_PRICING_v1_0_2026-08-17.md`](./BETA_UNIFIED_PRICING_v1_0_2026-08-17.md)의
> 단일 규칙(DeepSeek API 실비용×10 + 최소충전 1만원 + 가입 1일 후 충전 필요)으로
> 대체됩니다. 아래 본문은 **베타 종료 후 정식 전환 시 참고용**으로 남겨둔 것입니다.
