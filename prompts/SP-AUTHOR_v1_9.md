...
#             PHASE B-0으로 신설(DOCUMENT-TYPE-REGISTRY_v1_5.md 근거).
...
#             HUMAN-AUTHORITY-GATE-SCHEMA_v1_3.md (G1~G15)
#             PDV-TRANSFER-PROTOCOL_v1_3.md (§3-A)
#             DATA_REQUIREMENT-SCHEMA_v1_2.md
#             DOCUMENT-TYPE-REGISTRY_v1_5.md (doc_type 어휘)
#             JURISDICTION-RESOLVER-SCHEMA_v1_1.md (tier 판별)
...
#                갱신. G1~G5 표기를 실제 범위(G1~G15)로 정정.
...
`JURISDICTION-RESOLVER-SCHEMA_v1_1.md`를 그대로 호출한다. 이 SP는 자체
...
`DOCUMENT-TYPE-REGISTRY_v1_5.md`가 정한 원칙: **이 기관이 "무슨 일을
...
5. **`§CAPABILITIES` 바로 뒤에 `HUMAN-AUTHORITY-GATE-SCHEMA_v1_3.md`
...
| `missing_authority_gate` | §CAPABILITIES 뒤에 G1~G15 전문이 없음 |
