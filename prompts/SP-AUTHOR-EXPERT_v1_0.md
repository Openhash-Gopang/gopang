...
#             동일한 층위, 대상만 다름).
# 필수 선행 문서:
#             SP_common_guardrails.md (매니페스트 경유 최신본 — SP-COMMON-02,
#               모든 페르소나의 공통 상속 상위 — PHASE C는 이 문서를 절대
#               재작성하지 않고 인용만 한다. 2026-07-29 정정: v3_10을
#               박제 참조하고 있었음, 실제 최신은 v3_18)
...
3. **상속 선언**: 어떤 경우든 `SP_common_guardrails.md`(매니페스트 경유 최신본, SP-COMMON-02)
