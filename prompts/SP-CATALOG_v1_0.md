...
## ③ 전문가 AI (`EXPERT_REGISTRY`, 26개 페르소나)
...
```
UNIVERSAL-INTEGRITY
  └─ SP_common_guardrails_v3_2.md (전체 26개 공통)
       └─ SP_common_medical_safety_v1_2.md (의료 계열만 추가 — 11개)
            └─ SP_{persona}_v2_x.md (개별 페르소나 SP)
```

법률(1)·세무(1)·의료(11)·교육(1)·상담(3)·문화(2)·공학(4)·해사(4) 4그룹
26개. `[EXPERT: {personaId}]` 태그로 GWP와 동일한 새 탭 방식 호출(2026-07-03
이후 통일).
