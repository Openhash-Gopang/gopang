...
add('K-govType가드', '부산 재산세 얼마 나왔는지 궁금해요', { expectTrace: ['govType 가드'], expectNotTrace: ['SP-DO-PLAN'], note: 'busan은 GENERAL — 세정은 시군구 소관, 시군구명 없어 미확정 처리돼야 함' });
add('K-govType가드', '해운대구 취득세 계산 좀 도와주세요', { expectTrace: ['SP-SIGUNGU-LAZY'], note: '시군구명 있음 — govType 가드 통과 후 지연조회로' });
