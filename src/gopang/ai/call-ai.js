...
export function _buildFirstContactContext() {
  ...
  if (!firstGreeted) {
    ...
    // 사용자 지정 환영 문구 — 한 글자도 바꾸지 말 것 (2026-07-13 재갱신 —
    // 예/아니오로 동의를 구하던 방식에서 첫 질문으로 곧장 들어가는 방식으로.
    // 사고실험(0003님 사례)에서 이 스크립트가 사용자의 실질적 질문을
    // 완전히 무시하고 가로채는 문제가 확인돼, 예외 조항도 함께 추가.
    return (
      ...
      ` 작성하겠습니다. 첫째 질문입니다. 혹시 판매하시는 상품이 있나요?\n` +
