...
const JEJU_L2_TABLE = [
  ...
  { code: 'SP-DO-WELFARE',  file: '02-do-dept/SP-DO-WELFARE_v1.2.md',
    ...
    kw: ['복지가족국', '보건복지여성국', '기초생활수급', '기초연금', '보육료', '어린이집', '장애인복지', '한부모',
         '복지', '임신', '난임', '출산', '육아', '보육', '장애인', '여성가족'] },  // ★ 2026-08-23 '난임' 추가(사고실험 발견)
...
const JEJU_CITY_DEPT_TABLE = [
  { 국코드: 'jachi', 시코드: 'jejusi',
    ...
    kw: ['자치행정국', '총무과', '기획예산과', '세무과', '재산세과', '지방세', '여권', '자동차세'] },  // ★ 2026-08-23 '자동차세' 추가(사고실험 발견) — 취득세 등과 동일하게 개별 세목은 시청 세무과 소관
...
const _JACHI_PASSPORT_LOOKUP_SIGNALS = ['진위', '발급 이력', '발급이력', '발급 상태', '발급상태', '정보증명서'];
...
const JEJU_NATIONAL_TABLE = [
  ...
  { code: 'SP-NAT-TAX',
    domain: 'tax', 도코드: 'jeju',
    kw: ['세무서', '국세', '종합소득세', '부가가치세', '법인세', '홈택스', '사업자등록', '세금 환급금', '소득확인증명서', '신고사실없음'] },  // ★ 2026-08-23 추가(사고실험 발견)  // ★ 2026-08-23 추가(사고실험 발견) — "사업자등록증명" 등
  { code: 'SP-NAT-COURT',
  ...
  { code: 'SP-NAT-LABOR',
    ...
    kw: ['근로복지공단', '산재보험', '산업재해', '고용보험', '가족돌봄휴직'] },  // ★ 2026-08-23 추가(사고실험 발견)
...
const _POLICY_BODY_DOMAIN_KEYWORDS = {
  ...
  MOFA: ['외교부', '여권 진위', '여권정보증명서', '여권 발급 이력', '여권발급이력', '여권 발급 상태', '여권발급상태'],  // ★ 2026-08-23 추가(사고실험 발견) — 여권 중앙조회형 서비스(재발급/신청은 여전히 시/군/구 jachi 소관, BUG-016)
