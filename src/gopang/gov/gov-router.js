...
const JEJU_L2_TABLE = [
  ...
  { code: 'SP-DO-WELFARE',  file: '02-do-dept/SP-DO-WELFARE_v1.2.md',
    ...
    kw: ['복지가족국', '보건복지여성국', '기초생활수급', '기초연금', '보육료', '어린이집', '장애인복지', '한부모',
         '복지', '임신', '난임', '출산', '육아', '보육', '장애인', '여성가족', '차상위계층'] },  // ★ 2026-08-23 '난임'·'차상위계층' 추가(사고실험 발견)
...
const JEJU_CITY_DEPT_TABLE = [
  { 국코드: 'jachi', 시코드: 'jejusi',
    ...
    kw: ['자치행정국', '총무과', '기획예산과', '세무과', '재산세과', '지방세', '여권', '자동차세', '지방공무원경력증명', '지방공무원 경력증명'] },  // ★ 2026-08-23 '자동차세'·'지방공무원경력증명'(띄어쓰기 변형 포함) 추가(사고실험 발견) — 취득세 등과 동일하게 개별 세목은 시청 세무과 소관
  { 국코드: 'safety', 시코드: 'jejusi',
    kw: ['안전교통국', '안전총괄과', '교통행정과', '차량관리과', '교통', '차량등록', '주정차', '자동차등록', '자동차 등록'] },  // ★ 2026-08-23 '자동차등록' 추가(사고실험 발견) — "자동차등록증 재발급" 등 실발화형은 '차량등록'과 어순이 달라 안 걸렸음. '자동차 등록'(띄어쓰기)도 추가
  ...
  { 국코드: 'housing', 시코드: 'jejusi',
    ...
    kw: ['도시건설국', '도시계획과', '도시재생과', '건축과', '주택과', '상하수도과',
         '건축', '건축허가', '건축인허가', '건축신고', '도시계획', '개별공시지가', '토지이용계획'] },  // ★ 2026-08-23 '개별공시지가'·'토지이용계획' 추가(사고실험 발견)
  ...
  { 국코드: 'housing', 시코드: 'seogwipo',
    kw: ['안전도시건설국', '안전총괄과', '도시과', '건축과', '건설과', '교통행정과', '상하수도과',
         '건축', '건축허가', '건축인허가', '건축신고', '건설', '도시계획', '상하수도', '개별공시지가', '토지이용계획'] },  // ★ 2026-08-23 '개별공시지가'·'토지이용계획' 추가(사고실험 발견)
...
const _JACHI_PASSPORT_LOOKUP_SIGNALS = ['진위', '발급 이력', '발급이력', '발급 상태', '발급상태', '정보증명서', '발급기록', '분실'];  // ★ 2026-08-23 '발급기록'/'분실' 추가(4차 사고실험 발견) — "여권 발급기록 증명서", "여권 분실 신고"도 외교부 중앙 대국민서비스
...
const JEJU_NATIONAL_TABLE = [
  ...
  { code: 'SP-NAT-TAX',
    ...
    kw: ['세무서', '국세', '종합소득세', '부가가치세', '법인세', '홈택스', '사업자등록', '세금 환급금',
         '소득확인증명서', '신고사실없음', '세금 납부내역', '현금영수증', '근로장려금', '자녀장려금'] },  // ★ 2026-08-23 추가(1~4차 사고실험 발견)
  { code: 'SP-NAT-COURT',
  ...
  { code: 'SP-NAT-NHIS',
    ...
    kw: ['건강보험공단', '건강보험료', '건강검진', '건강보험 자격확인서', '건강보험 자격득실',
         ...
         '4대 사회보험료 완납증명서', '4대사회보험', '진료받은 내역'] },  // ★ 2026-08-23 추가(사고실험 발견) — 순수 '건강보험'은 과잉매칭 우려로 안 넣고 실제 발화형 복합어만 추가
  { code: 'SP-NAT-IMMIGRATION',
    domain: 'immigration', 도코드: 'jeju',
    kw: ['출입국', '외국인청', '체류자격', '비자', '귀화', '하이코리아', '외국인등록'] },  // ★ 2026-08-23 추가(사고실험 발견) — "외국인등록사실증명" 등
  { code: 'SP-NAT-POST',
    domain: 'post', 도코드: 'jeju',
    kw: ['우체국', '우정청', '등기우편', '우편'] },
  { code: 'SP-NAT-POLICE',
    domain: 'police', 도코드: 'jeju',
    kw: ['지방경찰청', '국가경찰', '112', '고소장', '수사', '경찰 사건조회', '경찰 사건 조회'] },  // ★ 2026-08-23 추가(사고실험 발견) — 처음엔 bare '경찰'을 넣었다가 "자치경찰이랑 일반경찰 차이가 뭐예요"(비교 질문) 회귀를 일으켜서, 정부24 실제 서비스명과 일치하는 복합어로 교체
  { code: 'SP-NAT-LABOR',
    domain: 'labor', 도코드: 'jeju',
    kw: ['근로복지공단', '산재보험', '산업재해', '고용보험', '가족돌봄휴직',
         '실업급여', '산재 요양', '생활안정자금', '보험료 완납 증명원'] },  // ★ 2026-08-23 추가(사고실험 발견)
...
const _NAT_AGENCY_DOMAIN_KEYWORDS = {
  ...
  nps: ['국민연금공단', '국민연금'],
  immigration: ['출입국', '비자', '외국인등록', '체류자격', '외국인청', '귀화', '하이코리아'],
  post: ['우정청', '우체국', '우편', '등기우편'],
  mma: ['병무청', '징병', '입영', '병역', '징병검사', '신체검사'],
  customs: ['세관', '관세', '통관'],
...
const _POLICY_BODY_DOMAIN_KEYWORDS = {
  ...
  MOFA: ['외교부', '여권 진위', '여권정보증명서', '여권 발급 이력', '여권발급이력', '여권 발급 상태', '여권발급상태',
    '여권 발급기록', '여권발급기록', '여권 분실'],  // ★ 2026-08-23 추가(4차 사고실험 발견)
...
const _EMERGENCY_FALSE_POSITIVE_WORDS = [
  ...
  // ★ 2026-08-23 추가(정부24 사고실험 발견) — "교통사고사실확인원"은 과거
  // 사고를 증명하는 서류 발급 요청이지 진행 중인 사고 신고가 아니다.
  // '교통사고'만 지우면 진짜 응급 신고("방금 교통사고 났어요")의 '사고'
  // 잔여 문자열이 다른 패턴과 오매칭될 수 있어, 서류명 전체를 통째로 지운다.
