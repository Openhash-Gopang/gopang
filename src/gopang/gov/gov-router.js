...
const JEJU_CITY_DEPT_TABLE = [
  ...
  { 국코드: 'safety', 시코드: 'jejusi',
    kw: ['안전교통국', '안전총괄과', '교통행정과', '차량관리과', '교통', '차량등록', '주정차', '자동차등록'] },  // ★ 2026-08-23 '자동차등록' 추가(사고실험 발견) — "자동차등록증 재발급" 등 실발화형은 '차량등록'과 어순이 달라 안 걸렸음
...
const JEJU_NATIONAL_TABLE = [
  ...
  { code: 'SP-NAT-TAX',
    domain: 'tax', 도코드: 'jeju',
    kw: ['세무서', '국세', '종합소득세', '부가가치세', '법인세', '홈택스', '사업자등록'] },  // ★ 2026-08-23 추가(사고실험 발견) — "사업자등록증명" 등
  { code: 'SP-NAT-COURT',
  ...
  { code: 'SP-NAT-NHIS',
    ...
    kw: ['건강보험공단', '건강보험료', '건강검진', '건강보험 자격확인서', '건강보험 자격득실'] },  // ★ 2026-08-23 추가(사고실험 발견) — 순수 '건강보험'은 과잉매칭 우려로 안 넣고 실제 발화형 복합어만 추가
