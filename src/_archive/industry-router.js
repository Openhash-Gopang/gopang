...
export const INDUSTRY_REGISTRY = [
  ...
  {
    code: '01', label: '농업',
    spFile: 'AGENT-SUPPLIER-01_agriculture_v3.0.txt',
    triggers: ['농업', '농장', '농사', '농산물직거래', '친환경농장', '밭농사', '논농사',
               '스마트팜', '원예농장', '화훼농장', '과수원', '과일농장'],
  },
  {
    code: '02', label: '임업',
    spFile: 'AGENT-SUPPLIER-02_forestry_v3.0.txt',
    triggers: ['임업', '임산물', '산림조합', '버섯재배', '수목재배', '조림', '산림경영',
               '임산업', '목재생산', '나무농장'],
  },
  {
    code: '03', label: '어업',
    spFile: 'AGENT-SUPPLIER-03_fisheries_v3.0.txt',
  ...
  /* ── B. 광업 ── */
  {
    ...
    spFile: 'AGENT-SUPPLIER-05_coal-oil-gas-mining_v3.0.txt',
    triggers: ['석탄광업', '원유채굴', '천연가스채굴', '유전개발', '탄광'],
  },
  {
    code: '06', label: '금속광업',
    spFile: 'AGENT-SUPPLIER-06_metal-mining_v3.0.txt',
    triggers: ['금속광업', '금광', '철광석채굴', '구리광산', '아연광산', '채광'],
  },
  {
    code: '07', label: '비금속광물 광업(연료용 제외)',
    spFile: 'AGENT-SUPPLIER-07_nonmetallic-mineral-mining_v3.0.txt',
    triggers: ['석회석채굴', '규석광업', '비금속광물', '골재채취', '모래채취', '석재채취'],
  },
  {
    code: '08', label: '광업 지원 서비스업',
    spFile: 'AGENT-SUPPLIER-08_mining-support-services_v3.0.txt',
  ...
  /* ── D. 전기·가스·수도 ── */
  {
    ...
    spFile: 'AGENT-SUPPLIER-35_electricity-gas-steam-supply_v3.0.txt',
    triggers: ['태양광발전사업', 'LPG충전소', '신재생에너지', '지역난방',
               '태양광설치', '발전사업', '에너지판매', '풍력발전'],
  },
  {
    code: '36', label: '수도사업',
    spFile: 'AGENT-SUPPLIER-36_water-supply_v3.0.txt',
  ...
  /* ── E. 폐수·환경 ── */
  {
    ...
    spFile: 'AGENT-SUPPLIER-37_sewage-wastewater-treatment_v3.0.txt',
    triggers: ['정화조청소', '폐수처리업체', '분뇨수거', '하수처리', '오폐수처리'],
  },
  {
    code: '38', label: '폐기물 수집, 운반, 처리 및 원료 재생업',
    spFile: 'AGENT-SUPPLIER-38_waste-collection-recycling_v3.0.txt',
    triggers: ['폐기물처리업체', '재활용업체', '고철수거', '폐기물수거',
               '폐기물운반', '폐가전수거', '중고철', '재활용센터', '폐지수거'],
  },
  {
    code: '39', label: '환경 정화 및 복원업',
    spFile: 'AGENT-SUPPLIER-39_environmental-remediation_v3.0.txt',
  ...
  /* ── F. 건설업 ── */
  {
    ...
    spFile: 'AGENT-SUPPLIER-41_general-construction_v2.0.txt',
    triggers: ['건설사', '시공사', '건축회사', '주택건설', '아파트시공', '토목공사',
               '종합건설', '건설업체', '공사업체', '디벨로퍼', '시행사'],
  },
  {
    code: '42', label: '전문직별 공사업',
    spFile: 'AGENT-SUPPLIER-42_specialty-trade-construction_v2.0.txt',
  ...
  /* ── G. 도소매업 ── */
  {
    ...
    spFile: 'AGENT-SUPPLIER-45_automobile-parts-sales_v2.0.txt',
  ...
  },
  {
    ...
    spFile: 'AGENT-SUPPLIER-47_retail-trade_v2.0.txt',
  ...
  /* ── H. 운수·창고 ── */
  {
    ...
    spFile: 'AGENT-SUPPLIER-49_land-transport-pipeline_v2.0.txt',
    triggers: ['택배', '화물운송', '이사업체', '퀵서비스', '버스회사', '택시회사',
               '화물차', '용달', '화물기사', '운송업', '트럭운송', '냉동차'],
  },
  {
    code: '50', label: '수상 운송업',
    spFile: 'AGENT-SUPPLIER-50_water-transport_v2.0.txt',
    triggers: ['선박운송', '해운사', '도선업', '페리', '여객선', '카페리'],
  },
  {
    code: '51', label: '항공 운송업',
    spFile: 'AGENT-SUPPLIER-51_air-transport_v2.0.txt',
    triggers: ['항공사', '드론운송', '항공화물', '헬기운송', '항공운송'],
  },
  {
    code: '52', label: '창고 및 운송관련 서비스업',
    spFile: 'AGENT-SUPPLIER-52_warehousing-transport-support_v2.0.txt',
  ...
  {
    code: '55', label: '숙박업',
    spFile: 'AGENT-SUPPLIER-55_accommodation_v2.0.txt',
    triggers: ['호텔', '모텔', '펜션', '게스트하우스', '에어비앤비', '민박',
               '캠핑장', '숙박업', '리조트', '콘도', '글램핑', '한옥스테이'],
  },
  {
    code: '56', label: '음식점 및 주점업',
    spFile: 'AGENT-SUPPLIER-56_restaurants-bars_v2.0.txt',
  ...
  {
    code: '58', label: '출판업',
    spFile: 'AGENT-SUPPLIER-58_publishing_v2.0.txt',
    triggers: ['출판사', '책출판', '잡지사', '전자책', '독립출판',
               '교재출판', '웹툰출판', '도서출판'],
  },
  {
    code: '59', label: '영상·오디오 기록물 제작 및 배급업',
    spFile: 'AGENT-SUPPLIER-59_film-video-audio-production_v2.0.txt',
  ...
  {
    code: '60', label: '방송업',
    spFile: 'AGENT-SUPPLIER-60_broadcasting-streaming_v2.0.txt',
    triggers: ['방송국', '라디오방송', '인터넷방송', '팟캐스트',
               '온라인방송', '스트리밍서비스', 'OTT'],
  },
  {
    code: '61', label: '우편 및 통신업',
    spFile: 'AGENT-SUPPLIER-61_postal-telecommunications_v2.0.txt',
    triggers: ['통신사', '인터넷서비스', 'IPTV', '알뜰폰', '통신망운영',
               'ISP', '위성통신'],
  },
  {
    code: '62', label: '컴퓨터 프로그래밍, 시스템 통합 및 관리업',
    spFile: 'AGENT-SUPPLIER-62_computer-programming-it_v2.0.txt',
  ...
  },
  {
    ...
    spFile: 'AGENT-SUPPLIER-63_information-services_v2.0.txt',
  ...
  {
    code: '64', label: '금융업',
    spFile: 'AGENT-SUPPLIER-64_banking-finance_v2.0.txt',
    triggers: ['은행', '저축은행', '증권사', '투자회사', '신협', '새마을금고',
               '대부업', '투자조합', '벤처캐피탈', '사모펀드', '농협은행'],
  },
  {
    code: '65', label: '보험 및 연금업',
    spFile: 'AGENT-SUPPLIER-65_insurance_v2.0.txt',
    triggers: ['보험사', '보험대리점', '보험설계사', '보험회사', '손해보험',
               '생명보험', '공제조합'],
  },
  {
    code: '66', label: '금융 및 보험 관련 서비스업',
    spFile: 'AGENT-SUPPLIER-66_financial-insurance-support_v2.0.txt',
  ...
  {
    code: '68', label: '부동산업',
    spFile: 'AGENT-SUPPLIER-68_real-estate_v2.0.txt',
  ...
  {
    code: '70', label: '연구개발업',
    spFile: 'AGENT-SUPPLIER-70_research-development_v2.0.txt',
    triggers: ['연구소', 'R&D', '기술개발', '연구개발기관', '기업연구소',
               '연구개발업체', '기술연구소'],
  },
  {
    code: '71', label: '전문서비스업',
    spFile: 'AGENT-SUPPLIER-71_professional-services_v2.0.txt',
  ...
  /* ── O. 공공행정 ── */
  {
    ...
    spFile: 'AGENT-SUPPLIER-84_public-administration-defense_v2.1.txt',
  ...
  /* ── P. 교육 서비스업 ── */
  {
    ...
    spFile: 'AGENT-SUPPLIER-85_education-services_v2.0.txt',
  ...
  {
    code: '86', label: '보건업',
    spFile: 'AGENT-SUPPLIER-86_health-care_v2.0.txt',
  ...
  },
  {
    ...
    spFile: 'AGENT-SUPPLIER-87_social-welfare-services_v2.0.txt',
  ...
  /* ── R. 예술·스포츠·여가 ── */
  {
    ...
    spFile: 'AGENT-SUPPLIER-90_creative-arts-leisure_v2.0.txt',
  ...
  },
  {
    ...
    spFile: 'AGENT-SUPPLIER-91_sports-recreation_v2.0.txt',
  ...
  /* ── S. 협회·단체·수리·기타 ── */
  {
    ...
    spFile: 'AGENT-SUPPLIER-94_associations-organizations_v2.0.txt',
    triggers: ['협회', '조합', '단체', '재단', '비영리단체', '사단법인',
               '재단법인', '직능단체', '업종협회'],
  },
  {
    code: '95', label: '개인 및 소비용품 수리업',
    spFile: 'AGENT-SUPPLIER-95_personal-goods-repair_v2.0.txt',
    triggers: ['수리점', '세탁소', '구두수선', '시계수리', '전자제품수리', '핸드폰수리',
               '가전수리', '자전거수리', '의류수선', '가방수선', '수선집'],
  },
  {
    code: '96', label: '기타 개인 서비스업',
    spFile: 'AGENT-SUPPLIER-96_other-personal-services_v2.0.txt',
  ...
  },
  {
    ...
    spFile: 'AGENT-SUPPLIER-97_household-employment_v2.0.txt',
    triggers: ['가사도우미', '베이비시터', '산후도우미', '육아도우미',
               '가사서비스', '생활지원사', '가정관리사'],
  },
  {
    code: '98', label: '자가소비를 위한 가구의 재화 및 서비스 생산활동',
    spFile: 'AGENT-SUPPLIER-98_own-consumption-production_v2.0.txt',
    triggers: ['자가소비', '자급자족'],
  },
  ...
  /* ── U. 국제기구 ── */
  {
    ...
    spFile: 'AGENT-SUPPLIER-99_international-foreign-organizations_v2.0.txt',
